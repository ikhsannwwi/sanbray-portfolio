            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Form Add Comment Project</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" action="/admin/comment-project/insert-comment-project" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
