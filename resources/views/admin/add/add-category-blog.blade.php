            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" action="/admin/category-blog/insert-category-blog" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-column" class="form-control @error('category_blog') is-invalid @enderror"
                                                placeholder="Masukan Title Banner" name="category_blog">
                                                @error('category_blog')
